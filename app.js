...
function welcome(){    
    ...
    if (hour < 12) {
        welcomeContainer.innerHTML = "Bom Dia, " + userName;
    } else if (hour < 18) {
        welcomeContainer.innerHTML = "Boa Tarde, " + userName;
    } else {
        welcomeContainer.innerHTML = "Boa Noite, " + + userName;
    } 
}
...
function  quizResult(){
    ...
    let percetage = ((correctAnswers + bonus)/quiz.length) * 100;
    percetage = (percetage > 100 ? 100 : percetage);
    ...
    resultBox.querySelector(".percetage").innerHTML = percetage.toFixed(2) + "%";
